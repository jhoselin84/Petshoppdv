...
public class Sobre extends JDialog {
	...
	public Sobre() {
		...
		lblDescricao.setBounds(26, 58, 279, 14);
		getContentPane().add(lblDescricao);
		
		JLabel lblAutor = new JLabel("Autor Professor José de Assis");
		lblAutor.setBounds(26, 83, 188, 14);
